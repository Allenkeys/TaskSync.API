...
public interface ITicketService
{
    ...
    Task<IEnumerable<Ticket>> GetTicketByDate(string userId, GetTicketRequest request);
    Task<IEnumerable<Ticket>> GetTicketDueInCurrentWeek(string userId, GetTicketRequest request);
